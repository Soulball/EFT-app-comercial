...
class Cine extends StatelessWidget {
  ...
  Cine({Key key, this.dataC}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: CustomText(
              data: 'Catalogo de Comisiones Cinepolis',
              size: 14,
              color: whiteNeutral,
  ...
  Widget _generateFirstColumnRow(BuildContext context, int index) {
    return Container(
      child: Text(dataC[index].classificationName),
      width: 100,
      height: 52,
      padding: EdgeInsets.fromLTRB(5, 0, 0, 0),
      alignment: Alignment.centerLeft,
      ...
      children: <Widget>[
        Container(
          child: Row(
            children: <Widget>[
              Container(
                child: Text(dataC[index].employeeAmount.toString()),
                width: 100,
                height: 52,
                padding: EdgeInsets.fromLTRB(5, 0, 0, 0),
                alignment: Alignment.centerLeft,
              ...
              Container(
                child: Text(dataC[index].quantity.toString()),
                width: 100,
                height: 52,
                padding: EdgeInsets.fromLTRB(5, 0, 0, 0),
                alignment: Alignment.centerLeft,
              ...
              Container(
                child: Text(dataC[index].currency),
                width: 100,
                height: 52,
                padding: EdgeInsets.fromLTRB(5, 0, 0, 0),
                alignment: Alignment.centerLeft,
